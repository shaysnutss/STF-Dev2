...
public class CommunicateViewModel extends AndroidViewModel {
    ...
    private void sendingpostreq2(String type,String method,String paramname,String param) {
        okhttp3.Request request;
        String url = "http://54.169.121.229:5000";
    ...
    private void onMessageReceived(String message) {
        ...
        messagesData.postValue(messages.toString());
        sendingpostreq2("post", "POST", "hi", message);
    }
